...
Usage:
    ...
    .venv/Scripts/python.exe scripts/pipeline/batch_stage3_parallel.py --gpu-workers 2

    # CPU-only run
    .venv/Scripts/python.exe scripts/pipeline/batch_stage3_parallel.py --workers 8 --no-gpu

    # Single chart type
    .venv/Scripts/python.exe scripts/pipeline/batch_stage3_parallel.py --chart-type bar --gpu-workers 2

    # Check progress without running
    .venv/Scripts/python.exe scripts/pipeline/batch_stage3_parallel.py --status

    # Small test run
    .venv/Scripts/python.exe scripts/pipeline/batch_stage3_parallel.py --chart-type area --limit 50
"""
