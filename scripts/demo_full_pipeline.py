...
Usage:
    python scripts/demo_full_pipeline.py path/to/chart.png
    python scripts/demo_full_pipeline.py --random  # Pick random chart from dataset
    python scripts/demo_full_pipeline.py --chart-type bar --random
