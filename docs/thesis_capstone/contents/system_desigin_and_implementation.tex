...
\begin{enumerate}
    \item \textbf{EfficientNet-B0} \cite{tan2019efficientnet}: CNN on $224 \times 224$ RGB
          input, 3 classes (bar, line, pie), 97.54\% test accuracy, 4.01\,M parameters.
          Confidence threshold 0.70; images below threshold are labelled \texttt{unknown}.
